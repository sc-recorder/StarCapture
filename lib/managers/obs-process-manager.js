...
class OBSProcessManager extends BaseManager {
    constructor() {
        ...
        // Always use LOCALAPPDATA for downloaded resources, even when packaged
        ...
        this.configPath = path.join(resourcesBase, 'obs-studio', 'config');
        
        this.logger.log('OBS Process Manager initialized');
        this.logger.log('Resources base:', resourcesBase);
